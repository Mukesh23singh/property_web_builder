...
PwbSectionsController.prototype.contact_us = function () {
  ...
  //   };
  //   $.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyDv76Ke07BbKYJBpAecTcMGIjXgpO5p4yM&v=3.exp&sensor=false&callback=map_callback&libraries=places');
  // } else {
  //   INMOAPP.showMap(currentItemForMap);
  // }
};
