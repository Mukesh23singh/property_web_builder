module Pwb
  ...
  class EnquiryMailerPreview < ActionMailer::Preview
    ...
    #   @message = Message.new(email: "jd@99kasare.com")
    #   EnquiryMailer.general_enquiry_targeting_enquirer(Tenant.first, @message)
    # end

    def general_enquiry_targeting_agency
      @message = Message.new(origin_email: "jd@99kasare.com", delivery_email: "test@test.com")
      @client = Client.new(first_names: "John Doe", phone_number_primary: "22 44", email: "jd@99kasare.com")
    ...
    def property_enquiry_targeting_agency
      ...
      @message = Message.new(origin_email: "jd@99kasare.com", url: "http://test.com", title: title)
      @property = Prop.last
      @client = Client.new(first_names: "John Doe", phone_number_primary: "22 44", email: "jd@99kasare.com")
